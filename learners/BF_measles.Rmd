...
each one if susceptible, and can call this $\beta$ for short. If the infection
...
$\beta.\frac{\mathbf{S}}{\mathbf{N}}$ susceptible individuals per
time unit, where $\beta = \mathcal{P} .\mathbf{k}$ is called the
...
take time to show symptoms. This time period is known as the latent
...
output %>%
  ...
  labs(
    ...
    caption = expression(
      paste(
        "The dynamics of SIER model with ",
        italic(R)[0], "= 15, ",
...
output %>%
  ...
  labs(
    ...
    caption =
      expression(
        paste(
          "SIER model showing the trajectories of the number of ",
...
output3 %>%
  ...
  labs(
    ...
    caption =
      expression(
        paste(
          "SIER with vaccine  showing the trajectories of the number of ",
...
output4 %>%
  ...
  labs(
    ...
    caption = "SIER model with vaccination and contact reduction:
