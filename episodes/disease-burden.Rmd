...
tail_value <- quantile(onset_to_admission, 0.999)

hospitalizations <- convolve(hosp, rev(density(onset_to_admission, 0:tail_value)), type = "open")[1:length(hosp)]
discharges <- convolve(hospitalizations, rev(density(admission_to_discharge, 0:tail_value)), type = "open")[1:length(hospitalizations)]
