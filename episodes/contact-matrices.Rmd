...
To normalise a matrix we scale the matrix so that the largest eigenvalue is 1. This transformation scales the entries between 0 and 1 but preserves the relative differences between the entries. 

To perform this normalisation we divide all entries of the matrix by the largest eigenvalue of the matrix.
