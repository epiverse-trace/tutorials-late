...
```{r}
# create new column of cumulative infections
vaccinate_01_infections$cumulative_infections <- cumsum(vaccinate_01_infections$new_infections)
vaccinate_02_infections$cumulative_infections <- cumsum(vaccinate_02_infections$new_infections)

pivot_longer(vaccinate_01_infections, cols = "cumulative_infections")
