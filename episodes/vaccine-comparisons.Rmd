...
When vaccine programs are not immediately available to be rolled out, either from capacity or development perspective, we want to know how non-pharmaceutical interventions (NPIs) can be used to best control the epidemic in the mean time, and after a vaccine program has started. Additionally, in the case of some infections, targeting specific risk groups for vaccination may be more effective than vaccinating everyone. 
