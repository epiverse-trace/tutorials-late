...
- **Non-pharmaceutical interventions (NPIs)**: Actions, apart from getting vaccinated and taking medicine, that people and communities can take to help slow the spread of illnesses.
...
```{r, echo = FALSE}
vaccinate_01_age <- new_infections(output_vaccinate_01,
                                   compartments_from_susceptible =
                                     "vaccinated", by_group = TRUE)
...
vaccinate_group_2_age <- new_infections(output_vaccinate_group_2,
                                        compartments_from_susceptible =
                                          "vaccinated", by_group = TRUE)
...
vaccinate_group_3_age <- new_infections(output_vaccinate_group_3,
                                        compartments_from_susceptible =
                                          "vaccinated", by_group = TRUE)
...
baseline_age <- new_infections(output_baseline,
                               compartments_from_susceptible =
                                 "vaccinated", by_group = TRUE)
