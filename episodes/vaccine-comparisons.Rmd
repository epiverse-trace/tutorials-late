...
To compare the impact of the interventions we can compare the cumulative infections under each program. We can see the difference in infection numbers is by several orders of magnitude.
