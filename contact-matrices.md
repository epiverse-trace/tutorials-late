...
<!--html_preserve--><div class="grViz html-widget html-fill-item" id="htmlwidget-8e9bfce11c70583974fa" style="width:504px;height:504px;"></div>
<script type="application/json" data-for="htmlwidget-8e9bfce11c70583974fa">{"x":{"diagram":"digraph {\n\n  # graph statement\n  #################\n  graph [layout = dot,\n         rankdir = LR,\n         overlap = true,\n         fontsize = 10]\n\n  # nodes\n  #######\n  node [shape = square,\n       fixedsize = true\n       width = 1.3]\n\n       S\n       I\n       R\n\n  # edges\n  #######\n  S -> I [label = \" infection \n(transmission rate &beta;)\"]\n  I -> R [label = \" recovery \n(recovery rate &gamma;)\"]\n\n}","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->
